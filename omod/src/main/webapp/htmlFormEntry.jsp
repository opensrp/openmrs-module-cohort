        ...
        $j('#deleteButton').click(function () {
            ...
            $j.post("<c:url value="/module/htmlformentry/deleteEncounter.form"/>",
                    ...
                    function (data) {
                        ...
                        if (url == null || url == "") {
                            url = "${pageContext.request.contextPath}/module/cohort/dashboard.form?cid=${command.cohort.cohortId}";
                        }
...
<c:if test="${command.context.mode != 'VIEW'}">
    <div id="passwordPopup"
         style="position: absolute; z-axis: 1; bottom: 25px; background-color: #ffff00; border: 2px black solid; display: none; padding: 10px">
        <center>
            <table>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="center"><input type="button" value="Submit"
                                                          onClick="loginThenSubmitHtmlForm()"/></td>
                </tr>
            </table>
        </center>
    </div>
