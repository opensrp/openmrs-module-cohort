...
<title>Manage Cohort Attributes Type</title> <!--set page title-->
</head>
...
<div class="container">
    <div class="row">
        <div class="col-sm-10">
            <h4 class="heading"><span>Manage Cohort Attributes Type</span></h4>
                ...
                <div class="row">
                        ...
                        <form id="login" method="get">
                            <div class="input-group">
                                <spring:bind path="cohortattributes.name">
                                    ...
                                    <input class="search form-control" type="text" id="name" name="name" value="${status.value}" placeholder="Search Cohort Attributes Type"
                                           required>
                    ...
                    <div class="col-sm-3 ">
                        <a class="btn btn-primary" href="addCohortAttributesType.form" style="padding-top: 0; padding-bottom: 0">
                            <h4>
                                <i class="fa fa-plus-square-o fa-lg"></i> Add Cohort Attributes Type
                            </h4>
                        </a>
                    </div>
